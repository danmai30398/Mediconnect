        ...
        try {
            ...
            const result = await fetch(`${API_BASE_URL}/api/login`, {
                ...
                headers: {
                    ...
                    'Accept': 'application/json', // Laravel cần
                    // Không cần X-XSRF-TOKEN nếu dùng cookie (Laravel xử lý tự động)
                },
                credentials: 'include', // bắt buộc để gửi cookie kèm request
            ...
            console.log("data: ", result); //debug status and object response

            //Step 3: call API secured
