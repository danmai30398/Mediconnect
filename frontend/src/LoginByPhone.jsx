        ...
        try {
            ...
            if (!res.ok) {
                try {
                    ...
                    let errorMessage = err?.message || "Incorrect Phone or password!";
            ...
            <form onSubmit={handleSubmit}>
                <div className="container mt-4 registerForm">
                    ...
                    <div className="row mb-3">
                        <div className="email_lg col-6"><a href="/login" className="text-center email_edit" >Email</a></div>
                        <div className="phone_lg phone_lg1 col-6"><a href="/login_phone" className="text-center phone_edit">Phone</a></div>
                    </div>
