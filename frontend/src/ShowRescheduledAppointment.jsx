                    ...
                    {filteredAppointments?.length > 0 ? (
                                    ...
                                    <div key={index} className="container m-3 col-12 col-md-6 col-lg-5 border rounded p-4 bg-light shadow">
                                        <div >
                                            ...
                                            <div className="row mt-3">
                                                ...
                                                <div className="col-7 text-end">Rescheduled - appointment has been rescheduled</div>
                                            </div>
                                        </div>
                                    </div>
                                );
                        ...
                        <div className="d-flex align-items-center mt-5 docSearch" style={{ height: '50vh' }} >
                            <div className="mx-auto">
                                ...
                                <p className="text-center">You don't have any rescheduled appointment.</p>
                            </div>
                        </div>
                    )}
                </div>)}
...
export default ShowRescheduledAppointment;
