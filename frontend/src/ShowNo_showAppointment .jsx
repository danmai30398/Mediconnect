                    ...
                    {filteredAppointments?.length > 0 ? (
                                    ...
                                    <div key={index} className="container m-3 col-12 col-md-6 col-lg-5 border rounded p-4 bg-light shadow">
                                        <div >
                                            ...
                                            <div className="row mt-3">
                                                ...
                                                <div className="col-7 text-end">No-show - the patient did not attend the appointment</div>
                                            </div>
                                        </div>
                                    </div>
                                );
                        ...
                        <div className="d-flex align-items-center mt-5 docSearch" style={{ height: '50vh' }} >
                            <div className="mx-auto">
                                ...
                                <p className="text-center">You don't have any no-show appointment.</p>
                            </div>
                        </div>
                    )}
                </div>)}
...
export default ShowNo_showAppointment;
