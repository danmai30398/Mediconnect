...
function ShowPendingAppointment({ data, loading, fetchData }) {
    const navigate = useNavigate();

    const filteredAppointments = data?.appointments?.filter(apt => apt.status === 'pending');
    // console.log("data pending:", filteredAppointments);
                    ...
                    {filteredAppointments?.length > 0 ? (
                                    ...
                                    <div key={index} className="container m-3 col-12 col-md-6 col-lg-5 border rounded p-4 bg-light shadow">
                                        <div >
                                            ...
                                            <div className="row mt-3">
                                                ...
                                                <div className="col-7 text-end">Pending - waiting for confirmation from the doctor</div>
                                            </div>
                                            <hr />
                        ...
                        <div className="d-flex align-items-center mt-5 docSearch" style={{ height: '50vh' }} >
                            <div className="mx-auto">
                                ...
                                <p className="text-center">You don't have any pending appointment.</p>
                            </div>
                        </div>
                    )}
                </div>)}
...
export default ShowPendingAppointment;
