...
function PatientEdit() {
    ...
    const checkUsername = async () => {
        console.log('formField.username: ', formField.username);
    ...
    const handleUpdate = async (e) => {
        ...
        // formData.append('formField.patient.name', formField.patient.name);
        // formData.append('formField.patient.email', formField.patient.email);
        // if (formField.patient.image) formData.append('formField.patient.image', formField.patient.image);
